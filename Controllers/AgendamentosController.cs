...
namespace IDonateApp.Controllers
{
    public class AgendamentosController : Controller
    {
        ...
        public AgendamentosController(IdonateApp context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AgendamentoId,OngId,Data,UsuarioId")] Agendamento agendamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AgendamentoId,OngId,Data,UsuarioId")] Agendamento agendamento)
        {
